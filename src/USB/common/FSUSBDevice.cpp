...
std::string FSUSBDevice::GetFrendlyProductNameFromID(VenderIDType venderID, ProductIDType productID)
{
 ...
 std::string  FSUSBDevice::GetFrendlyVenderNameFromID(VenderIDType venderID)
{
