...
FSUSBDeviceManager::FSUSBDeviceManager()
{
    ...
    */
    ...
    _usageMapToInputEvent[Gtron][GtronRetroSNES][589826] = ButtonB ;
    _usageMapToInputEvent[Gtron][GtronRetroSNES][589827] = ButtonA ;
    _usageMapToInputEvent[Gtron][GtronRetroSNES][589825] = ButtonY;
    _usageMapToInputEvent[Gtron][GtronRetroSNES][589828] = ButtonX;
    ...
    _usageMapToInputEvent[Gtron][GtronRetroSNES][589833] = ButtonSelect;
    _usageMapToInputEvent[Gtron][GtronRetroSNES][589834] = ButtonStart;
...
{
    std::unordered_map<IDNumber,std::vector<FSUSBElementInfoMap> >::iterator itRange = _usageMapToInputRangeEvent[vendorUSBID][productUSBID].begin();
...
bool FSUSBDeviceManager::doesDeviceHaveDeviceInput(unsigned int vendorUSBID, unsigned int productUSBID ,FSDeviceInput inputToLookFor)
{
    ...
    if(FS_isButtion(inputToLookFor) || FS_isDpad(inputToLookFor))
    {
        ...
        std::unordered_map<IDNumber,FSDeviceInput>::iterator itDigital = _usageMapToInputEvent[vendorUSBID][productUSBID].begin();
