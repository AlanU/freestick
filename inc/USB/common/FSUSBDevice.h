...
namespace freestick
{
    ...
    public:
       ...
       std::string getProductFrendlyName()const{
          return _productIDFriendlyName;
       }
       ...
       static std::string getFrendlyVendorNameFromID(
           const vendorIDType vendorID);
       static std::string getFrendlyProductNameFromID(
           const vendorIDType vendorID
