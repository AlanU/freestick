...
typedef enum
{
    ...
    {
    public:
        virtual void gamepadWasAddedFromJINBridge(s32 hid_id,JavaVM* jvm) = 0;
        virtual void gamepadWasRemovedFromJINBridge(s32 hid_id) = 0;
        virtual bool gamepadWasUpdatedFromJINBridge(s32 deviceid,s32 code,JNICallBackType type,float value,s32 min,s32 max) = 0;
    };
